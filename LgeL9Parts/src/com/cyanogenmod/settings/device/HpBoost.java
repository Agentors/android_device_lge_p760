...
public class HpBoost implements OnPreferenceChangeListener {

    private static final String FILE = "/sys/devices/virtual/misc/soundcontrol/volume_boost";
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DevicePreferenceActivity.KEY_HP_BOOST, "1"));
    }
